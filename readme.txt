--- Unmaintained, last update: Summer 2019 ---

Hopping Over the GFW of China (my "kit" anyway)

1. Lantern (https://getlantern.org/) - Windows | Linux | Android
...
4c. Tor w/ custom bridge servers that I operate - 139.59.97.244:34603 (obfs4) [DEPRECATED!]
...
7. Online proxy (that I operate) - https://j0e.ca/proxy [do note that all traffic is monitored and URLs visited will be stored temporarily]
8. Comercial VPN solution
  ...
  -> Commercial Shadowsocks servers - variety of them (both paid and free) can be found online
